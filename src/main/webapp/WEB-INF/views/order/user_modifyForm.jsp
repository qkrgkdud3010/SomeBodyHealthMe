...
<script type="text/javascript">
	$(function(){
		...
		$('#modify_form').submit(function(){
			const goods = document.querySelectorAll('.input-check');
			for(let i=0;i<goods.length;i++){
				if(goods[i].value.trim()==''){
					const label = document.querySelector(
							       'label[for="'+goods[i].id+'"]');
...
<div class="page-main">
	...
	<div class="content-main">
		...
		<form id="modify_form" action="modify.do"
		                                method="post">
			<input type="hidden" name="order_num" value="${order.order_num}" id="order_num">
			<ul>
				<li>
				...
				<li>
					...
					<textarea rows="5" cols="30"
					  name="notice" maxlength="1300">${order.notice}</textarea>
				</li>
			</ul> 
